    ...
    return (
        <div className='min-h-screen bg-linear-to br from-gray-50 to-emerald-50 py-10'>
            <div className='w-[90vw] lg:w-[70vw] max-w-[90%] mx-auto'>
                ...
                hover:shadow-md transition'><FaArrowLeft className='' />
                    </button>
                    <div>
                        <h1 className='text-3xl font-bold flex-nowrap text-fray-800'>
                            Interview History
                        </h1>
                                    ...
                                    <div className='flex items-center gap-6'>
                                        <div className='text-right'>
                                            <p className='text-xl font-bold text-emerald-600'>
                                                {item.questionWiseScore && item.questionWiseScore.length > 0
                                                    ? (
                                                        item.questionWiseScore.reduce((sum, q) => {
                                                            let score = q.score || 0;
                                                            let converted = score <= 10 ? score : (score / 25) * 10;
                                                            return sum + converted;
                                                        }, 0) / item.questionWiseScore.length
                                                    ).toFixed(1)
